...
client_go_gen:
	...
	client-gen -o ./ --input 'topo/v1beta1' --clientset-name versioned --input-base 'vitess.io/vitess/go/vt/topo/kubernetestopo/apis/' -i vitess.io/vitess --output-package vitess.io/vitess/go/vt/topo/kubernetestopo/client/clientset --go-header-file $(GEN_BASE_DIR)/boilerplate.go.txt
	lister-gen -o ./ --input-dirs  vitess.io/vitess/go/vt/topo/kubernetestopo/apis/topo/v1beta1 --output-package vitess.io/vitess/go/vt/topo/kubernetestopo/client/listers --go-header-file $(GEN_BASE_DIR)/boilerplate.go.txt
	informer-gen -o ./ --input-dirs  vitess.io/vitess/go/vt/topo/kubernetestopo/apis/topo/v1beta1 --versioned-clientset-package vitess.io/vitess/go/vt/topo/kubernetestopo/client/clientset/versioned --listers-package vitess.io/vitess/go/vt/topo/kubernetestopo/client/listers --output-package vitess.io/vitess/go/vt/topo/kubernetestopo/client/informers --go-header-file $(GEN_BASE_DIR)/boilerplate.go.txt

	# Move and cleanup
	mv vitess.io/vitess/go/vt/topo/kubernetestopo/client go/vt/topo/kubernetestopo/
	rmdir -p vitess.io/vitess/go/vt/topo/kubernetestopo/
